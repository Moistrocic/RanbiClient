...
MACRO_CONFIG_STR(RcShowEnableSkipThreeTilesInfoPositionY, rc_show_enable_skip_three_tiles_info_position_left_text, 128, "←", CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_STR(RcShowEnableSkipThreeTilesInfoPositionY, rc_show_enable_skip_three_tiles_info_position_right_text, 128, "→", CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_STR(RcShowEnableSkipThreeTilesInfoPositionY, rc_show_enable_skip_three_tiles_info_position_dj_left_text, 128, "↖", CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
MACRO_CONFIG_STR(RcShowEnableSkipThreeTilesInfoPositionY, rc_show_enable_skip_three_tiles_info_position_dj_right_text, 128, "↗", CFGFLAG_CLIENT | CFGFLAG_SAVE, "")
